...
function Recordings({ data, onClear, onReprocess, onUpload }: { data?: RecordingItem[]; onClear: (meetingId: number) => void; onReprocess: (meetingId: number, recordingUrl: string) => void; onUpload: (event: React.ChangeEvent<HTMLInputElement>) => void }) {
